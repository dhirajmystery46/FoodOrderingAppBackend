...
public class OrderService {
    ...
    public CustomerAuthTokenEntity getCoupon(final String authorization, final String coupon_name)
            throws AuthorizationFailedException, CouponNotFoundException {
        CustomerAuthTokenEntity customerAuthEntity = customerDao.getCustomerAuthToken(authorization);
        CouponEntity couponEntity  = (CouponEntity) orderDao.getCouponByCouponName(coupon_name);
