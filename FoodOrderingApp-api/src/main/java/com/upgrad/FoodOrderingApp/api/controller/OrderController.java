...
public class OrderController {
    ...
    @Autowired
    private CustomerAdminBusinessService customerService;
    ...
    public ResponseEntity<SaveOrderResponse> saveOrder(
        ...
        */
        ...
        saveOrderRequest.getRestaurantId()==null||saveOrderRequest.getPaymentId()==null||saveOrderRequest.getBill()==null) {
            throw new ItemNotFoundException("SOR-001", "No field should be empty except Coupon_Id and discount");
        }
        ...
        System.out.println(saveOrderRequest.getItemQuantities().get(0).getQuantity());
